...
import ICoinvestingDeFiPair from '@coinvestingdefi/dex-core/build/ICoinvestingDeFiPair.json';
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, ICoinvestingDeFiPair.abi, provider).getReserves()).then(function (_ref) {
