...
var ICoinvestingDeFiPair = _interopDefault(require('@coinvestingdefi/dex-core/build/ICoinvestingDeFiPair.json'));
...
var FACTORY_ADDRESS = '0xfC4516A7B8236Bad1B8DbB582d3830DFdd302625';
var INIT_CODE_HASH = '0xf414eaf687b005cd1d29be0b74430bb3d59f939715b3abbbb07af574ca27e22e';
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'COINVEX-V2', 'Coinvesting DeFi V2');
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, ICoinvestingDeFiPair.abi, provider).getReserves()).then(function (_ref) {
